...
{
    public partial class WsiteFamilyDetail
    {
        public int WsiteFamilyDetailId { get; set; }
        ...
        public virtual WsiteMember Member { get; set; }
        public virtual WsiteMember NomineeRelation { get; set; }
